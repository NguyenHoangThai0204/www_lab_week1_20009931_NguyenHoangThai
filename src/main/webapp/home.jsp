...
<body>
<div id="divBody" style="background-color: #effcfc;width: 60%;padding: 15px;border-radius: 25px;margin-top: 25px;border:1px solid blue">
    ...
    <table style="width: 100%;">
        <tr>
            ...
            <th><a methods="POST" style="margin-top: 10px;font-size: 25px" href="login?action=listGrantAccount">Danh sách GrantAcc</a></th>
    ...
    <form style="width: 60%; margin: auto;" method="POST" >
        ...
        <div class="row">
            <label class="title" style="text-align: left;margin-right: 5px;font-size: 25px;width: 30%;"
            >  ID</label>
